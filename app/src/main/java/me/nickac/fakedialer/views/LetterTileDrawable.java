...
public class LetterTileDrawable extends Drawable {
    ...
    int getContactTypeFromPrimitives(
    ...
    public LetterTileDrawable setOffset(float offset) {
        if (!(offset >= -0.5f && offset <= 0.5f)) return this;
        this.offset = offset;
        return this;
    }
    ...
    @IntDef({TYPE_PERSON, TYPE_BUSINESS, TYPE_VOICEMAIL, TYPE_GENERIC_AVATAR, TYPE_SPAM, TYPE_CONFERENCE})
